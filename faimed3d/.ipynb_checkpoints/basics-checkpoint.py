...
__all__ = ['read_medical_3d_image', 'show_one_3d_image', 'show_multiple_3d_images', 'crop_3d_tensor',
           'resize_3d_tensor', 'TensorDicom3D', 'load_image_3d', 'normalize']
...
# Cell
def show_one_3d_image(t: (np.ndarray, Tensor, TensorDicom3D), axis: int = 0, figsize: int = (15,15), cmap: str = 'bone', nrow: int = 10, return_grid = False):
    '''
...
# Cell
def show_multiple_3d_images(t_4d: Tensor, axis: int = 0, figsize: int = (15,15), cmap: str = 'bone', nrow: int = 10):
