...
__all__ = ['index_based_resize', 'Resize3D', 'Pad3D', 'RandomFlip3D', 'RandomRotate3D', 'RandomRotate3DBy',
           'RandomDihedral3D', 'RandomCrop3D', 'ResizeCrop3D', 'warp_3d', 'RandomWarp3D', 'sheer_3d', 'RandomSheer3D',
           'trapezoid_3d', 'RandomSheer3D', 'RandomNoise3D', 'RandomBrightness3D', 'RandomContrast3D', 'PseudoColor',
           'aug_transforms_3d', 'ClampMask3D', 'ReduceClasses']
...
@patch
def grid_tfms(t: (Tensor,TensorDicom3D,TensorMask3D), func, mode):
...
@patch
def gaussian_noise(t:(Tensor,TensorDicom3D), std):
...
class RandomNoise3D(RandTransform):
    ...
    def encodes(self, x:(Tensor,TensorDicom3D)):
