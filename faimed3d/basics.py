...
__all__ = ['readdcm_3d', 'show_image_3d', 'show_images_3d', 'crop_3d_tensor', 'TensorDicom3D', 'load_image_3d',
           'normalize', 'TensorMask3D']
...
# Cell
def readdcm_3d(fn: (pathlib.Path, str), div=None, return_scaled=False, return_normalized=False):
    '''
