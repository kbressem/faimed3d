...
__all__ = ['readdcm_3d', 'show_image_3d', 'show_images_3d', 'crop_3d', 'TensorDicom3D', 'load_image_3d', 'normalize',
           'TensorMask3D']
...
# Cell
def readdcm_3d(fn: (Path, str), div=None, return_scaled=False, return_normalized=False):
    '''
...
# Cell
def crop_3d(t: Tensor, margins: (int, float), perc_margins = False):
    '''
...
class TensorDicom3D(Tensor):
    ...
    def hist_scaled(self:Tensor, brks=None):
        ...
        return TensorDicom3D(x) # will loose meta data in process
